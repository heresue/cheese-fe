export default function TermsContent() {
  return (
    <article className="space-y-8 text-[14px] leading-[16px]">
      <p>
        본 이용약관은 치즈(이하 &quot;서비스&quot;)의 이용과 관련하여 회사와 이용자 간의
        <br />
      ...
      <section className="space-y-4">
        <h2>제1조 (목적)</h2>
        <p>
          이 약관은 치즈 서비스의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항을
          <br />
          규정함을 목적으로 합니다.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-decimal pl-5">
          <li>&quot;회사&quot;란 치즈 서비스를 운영하는 주체를 말합니다.</li>
          <li>&quot;서비스&quot;란 회사가 제공하는 웹사이트 및 관련 기능 전반을 의미합니다.</li>
          <li>
            &quot;이용자&quot;란 본 약관에 따라 서비스를 이용하는 회원 또는 비회원을 말합니다.
          </li>
          <li>&quot;회원&quot;이란 계정을 생성하여 서비스를 이용하는 자를 의미합니다.</li>
          <li>
            &quot;콘텐츠&quot;란 서비스 내에서 이용자가 작성하거나 제공하는 글, 이미지, 파일 등을
            말합니다.
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-decimal pl-5">
          <li>본 약관은 서비스 화면에 게시하거나 고지함으로써 효력이 발생합니다.</li>
          <li>
      ...
      <section className="space-y-4">
        <h2>제7조 (이용자의 의무)</h2>
        <p className="pl-[3px]">이용자는 다음과 같은 행위를 해서는 안 됩니다.</p>
        <ul className="list-decimal pl-5">
          <li>타인의 정보 도용</li>
          <li>불법 콘텐츠 게시</li>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-decimal pl-5">
          ...
          <li>
            이용자는 회사가 서비스 운영, 홍보 및 기능 제공을 위해 필요한 범위 내에서 콘텐츠를 사용할
            수 있도록 허락합니다.
          </li>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-decimal pl-5">
          ...
          <li>개인정보 처리방침은 서비스 내 별도 페이지에 게시합니다.</li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-decimal pl-5">
          <li>
            회사는 천재지변, 시스템 오류, 통신 장애 등 불가항력으로 인해 서비스를 제공할 수 없는
            경우 책임을 지지 않습니다.
          </li>
          <li>
            이용자가 서비스 이용 중 발생한 손해에 대해 회사는 고의 또는 중대한 과실이 없는 한 책임을
            지지 않습니다.
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        <h2>제11조 (분쟁 해결)</h2>
        <ul className="list-decimal pl-5">
          <li>회사와 이용자 간 분쟁은 가능한 상호 협의하여 해결합니다.</li>
          <li>협의가 이루어지지 않을 경우 관련 법령 및 관할 법원에 따릅니다.</li>
        </ul>
      </section>
      ...
      <section>
        <h2>부칙</h2>
        {/* TODO: 정식 배포일자로 수정 */}
        <p className="pl-[3px]">본 약관은 2026년 1월 30일부터 시행합니다.</p>
      </section>
    </article>
  );
}
