export const listFilterBarClassNames = {
  ...
  sortButton:
    'flex h-[44px] w-[66px] items-center justify-center gap-1 rounded-[8px] border border-border bg-bg-white text-text-muted outline-none transition-colors hover:border-secondary-500 hover:text-secondary-500 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-text-muted',
  ...
  actionButton:
    'inline-flex h-[44px] w-[76px] shrink-0 items-center justify-center gap-[4px] rounded-[10px] border border-secondary-600 bg-secondary-600 p-0 text-[14px] font-medium leading-[24px] tracking-[-0.02em] text-gray-50 transition-colors hover:border-secondary-700 hover:bg-secondary-700 disabled:cursor-not-allowed disabled:opacity-50',

  actionButtonIcon: 'h-[17px] w-[16px] shrink-0',

  actionButtonIconWrapper:
    'flex h-[17px] w-[16px] shrink-0 items-center justify-center [&>svg]:h-full [&>svg]:w-full',
};
