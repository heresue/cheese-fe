      ...
      <div className="px-4">
        <div className="flex items-center gap-3 px-2 py-1">
          <div className="relative flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[var(--color-tag-blue-100)] text-[11px] font-semibold text-[var(--color-tag-blue-500)]">
            김
            <span className="absolute -top-[1px] -right-[1px] h-[9px] w-[9px] rounded-full border border-[var(--color-bg)] bg-[var(--color-secondary-500)]" />
          </div>
        ...
        <ul className="flex flex-col gap-1">
          {navigationItems.map((item) => (
            <li key={item.label}>
              <Link
                href={item.href}
                className="group flex h-9 items-center gap-3 rounded-[10px] px-3 text-sm font-medium text-[var(--color-gray-700)] transition-colors duration-200 hover:bg-[var(--color-primary-300)] hover:text-[var(--color-gray-900)]"
              >
                <span className="flex h-[18px] w-[18px] items-center justify-center text-[var(--color-gray-600)] transition-colors duration-200 group-hover:text-[var(--color-secondary-700)]">
